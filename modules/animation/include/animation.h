#pragma once
#include <iostream>
#include <matplotlibcppl7/axes.h>
#include <matplotlibcppl7/figure.h>
#include <matplotlibcppl7/pyplot.h>
#include <memory>
#include <pybindll/embed.h>
...
namespace py = pybindll;
namespace mpl = matplotlibcppl7;
...
class Animation : public utilities::Singleton<Animation> { 
    ...
    -Animation() {}
    private:
    void EnvPltInit(int ratio,const pybindll::dict& fig_kwargs, const port::CommonPose& robot_pose);
    void MapPltInit(const pybindll::dict& fig_kwargs, int ratio, const port::CommonPose& robot_pose);
    void CmdPltInit(const pybindll::dict& fig_kwargs, const float& x_axis_range);
    void SensorPltInit(const pybindll::dict& fig_kwargs, const float& offset);
    void SpacePltInit(const pybindll::dict& fig_kwargs);
    public:
...
const mesh2D& dg_border, const pcnrt: :CommonPose& target,const bool erase, const bool blade);
