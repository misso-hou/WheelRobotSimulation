...
/*速度控制模式（优先级逐渐提高)*/
typedef enum { NORMAL, SLOWDOWN, SLOWUP_LEVEL1, SL0WUP_LEVEL2, SLOWDOWN_LEVEL1, SLOWDOWN_LEVEL2, SHUTDWON } ActionState;
...
/*控制模块内部状态结果*/
typedef enum { INIT = 0, TRACKING, SUCCESS } TrackinglnternalState;
