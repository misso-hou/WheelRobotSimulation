...
classTime {
 public
   ...
   */
  eProsima_user_DllExport Time(constTime & x);
   ...
   */
  eProsima_user_DllExport bool operator==(constTime& x) const;
   ...
   */
  eProsima_user_DllExportstaticsize_t getCdrSerializedSize(const builtin_interfaces::msg::Time& data, size_tcurrent_alignment = 0);
   ...
   * @param cdr CDR serialization object
   */
  eProsima_user_DllExport vold deserlallze(eprosima::fastcdr::Cdr & cdr);
